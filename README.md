...
- 파이썬 SQL Server 연동 프로그래밍'
    - Madang DB 관리 프로그램
        ...
        - SQL Server 데이터 핸들링
            ...
            > pip install pymssql
            ```
        - DB연결 설정 - Oracle, MySQL 등은 설정이 없은. 구성관리자에서 TCP/IP로 접근을 허용하지 않으면 접속 안됨
...
https://github.com/inje98/basic-database-2024/assets/158007381/4fb83e03-a2fb-4160-a71f-29ae1c0a8a91
...
- SQL 고급
    ...
    - TCL에서 사용할 키워드
        - BEGIN,  TRAN[SACTIION], COMMIT, ROLLBACK, SAVE
...
- 실무실습
    ...
    ![HR_ERD](https://github.com/hugoMGSung/basic-database-2024/blob/main/images/db005.png?raw=true)
